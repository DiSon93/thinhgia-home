  ...
  <div>
    <div class="rent_detail">
      ...
      <div class="address">
        ...
        <span>Đường Thi Sách, Phường 8, TP. Vũng Tàu</span>
      </div>
      ...
      <v-row>
        ...
        <v-col cols="12" sm="4">
          <FormUser />
          <div class="horizontal_title">NHÀ ĐẤT THUỘC DỰ ÁN</div>
          <div class="horizontal_image">
            ...
            <v-btn color="warning" class="readmore" @click="$router.push('/project/01')"
      ...
      <div class="estateOfProject">
        <div class="mobile_screen">
          <div class="estate_title">NHÀ ĐẤT THUỘC DỰ ÁN</div>
          <div id="img_estate">
        ...
        <div class="estate_title">BẤT ĐỘNG SẢN ĐÃ XEM</div>
        <div id="img_estate">
          <VueSlickCarousel :arrows="true" v-bind="settings02">
            <div class="estate_img">
              <el-card class="box-card">
