    ...
    <div>
        <div class="project_detail" v-if="projectDetail.id != undefined">
            <div class="project_img">
                <img :src="projectDetail.image_public[0].thumbnail" :alt="projectDetail.title" v-if="projectDetail.image_public.length > 0" />
                <img src="@image/layouts/picture_ngoctuoc2.png" :alt="projectDetail.title" v-else />
            </div>
            <v-row>
                <v-col cols="12" sm="8">
                    <div class="project_title" v-html="projectDetail.title"></div>
                    <div class="btn_groupitems">
                        <v-btn-toggle v-model="text" tile color="deep-purple accent-3" group>
                            ...
                            <a href="#vitri_blank">
                                <v-btn value="vitri" id="normal" @click="activeNames.push('2')">Vị trí</v-btn>
                            </a>
                            <a href="#tienich_blank">
                                <v-btn value="tienich" id="normal" @click="activeNames.push('3')">Tiện ích</v-btn>
                            </a>
                            <a href="#hinhanh_blank">
                                <v-btn value="hinhanh" id="normal" @click="activeNames.push('4')">Hình ảnh</v-btn>
                            </a>
                            <a href="#matbang_blank">
                                <v-btn value="matbang" id="normal" @click="activeNames.push('5')">Mặt bằng</v-btn>
                            </a>
                            <a href="#toanha_blank">
                                <v-btn value="toanha" id="normal" @click="activeNames.push('6')">Tòa nhà</v-btn>
                            </a>
                        </v-btn-toggle>
                    </div>
                    ...
                    <el-collapse v-model="activeNames" @change="handleChange">
                        <el-collapse-item title="TỔNG QUAN DỰ ÁN" name="1" id="overview" @click="text = 'tongquan'">
                            <div class="items">
                                <div>
                                    ...
                                    <span v-html="projectDetail.title"></span>
                                </div>
                            </div>
                            <div class="items">
                        ...
                        <div id="hinhanh" @click="text = 'hinhanh'">
                            ...
                            <el-collapse-item title="HÌNH ẢNH" name="4">
                                <img :src="img.thumbnail" :alt="projectDetail.title" v-for="img in projectDetail.image_public" :key="img.id" />
                            </el-collapse-item>
                        </div>
                            ...
                            <el-card class="box-card">
                                <div slot="header" class="clearfix hover14">
                                    <figure @click="$router.push(parseUrlRealEstate(re))">
                                        <img :src="re.image_public[0].thumbnail" :alt="re.title" v-if="re.image_public.length > 0" />
                                ...
                                <div class="add_detail">
                                    <div class="price">
                                        <div>
                                            <span class="first_price" v-html="[re.price, unit_prices[re.unit_price]].join(' ')"></span>
                                    ...
                                    <router-link class="name" :to="parseUrlRealEstate(re)" v-html="re.title"></router-link>
                                    ...
                                    <div class="address d-flex">
                                        ...
                                        <span v-html="[re.street_type_dict.name, re.district.name].join(', ')"></span>
                                    </div>
                                </div>
                            </el-card>
                        </div>
