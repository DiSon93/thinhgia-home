                ...
                <div v-for="item in projectList.projects" :key="item.id">
                        ...
                        <v-col cols="12" sm="6">
                            <div class="special_content">
                                ...
                                <v-row class="finish content">
                                    <v-col cols="1">
                                        <img src="@image/icons/tiendo.png" alt="" />
                                    </v-col>
                                    <v-col cols="11">
                                        <span>
                                            Tiến độ:
                                            <span class="highlight" v-html="item.progress < 100?item.progress+' %':'Đã hoàn thành'"></span>
                                        </span>
                                    </v-col>
                                </v-row>
                                <v-row class="content">
                                    <v-btn @click="$router.push('/project/detail/' + item.slug + '-' + item.id)">
                                        Xem chi tiết &gt;&gt;
                                    </v-btn>
                                </v-row>
                            </div>
                    ...
                    <div class="estateOfProject">
                        ...
                        <v-row id="img_estate" v-if="projectList.real_estates[item.id] != undefined">
                            <v-col cols="6" sm="4" lg="3" class="estate_img" v-for="re in projectList.real_estates[item.id]" :key="re.id">
