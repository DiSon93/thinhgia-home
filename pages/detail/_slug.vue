                ...
                <v-col cols="12" sm="8" id="app">
                    ...
                    <div class="overview">
                        ...
                        <v-row class="overview_content">
                            ...
                            <v-col cols="3">
                                <div>Giá</div>
                                <div class="number" v-html="[realEstateItem.price, unit_prices[realEstateItem.unit_price]].join(' ')"></div>
                            </v-col>
                            <v-col cols="3">
                                <div>Diện tích</div>
                            ...
                            <v-col cols="3">
                                <div>Hướng</div>
                                <div class="number" v-html="realEstateItem.house_orientation_dict.name"></div>
                            </v-col>
                        </v-row>
                        <v-row class="overview_content">
