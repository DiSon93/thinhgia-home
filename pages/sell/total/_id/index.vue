    ...
    <div>
      <div class="search_sell">
        <!-- <div class="search_link">
          {{ textTitle }}
          <i class="el-icon-arrow-right"></i> HCM
        </div> -->
        <SearchTool />
        <div class="search_content">
          <v-row class="tieude">
            <v-col cols="7" sm="7" lg="7">
              <div class="search_title">MUA BÁN {{ textTitle }}</div>
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.params.id == "chungcu") {
      this.textTitle = "CĂN HỘ/CHUNG CƯ";
    }
    if (this.$route.params.id == "nhariengle") {
      this.textTitle = "NHÀ Ở RIÊNG LẺ";
    }
    if (this.$route.params.id == "nhamattien") {
      this.textTitle = "NHÀ MẶT TIỀN";
    }
    if (this.$route.params.id == "bietthu") {
      this.textTitle = "BIỆT THỰ/VILLA";
    }
    if (this.$route.params.id == "nhanghi") {
      this.textTitle = "NHÀ NGHỈ/KHÁCH SẠN";
    }
    if (this.$route.params.id == "phongtro") {
      this.textTitle = "PHÒNG TRỌ";
    }
    if (this.$route.params.id == "khoxuong") {
      this.textTitle = "KHO XƯỞNG";
    }
    if (this.$route.params.id == "trangtrai") {
      this.textTitle = "TRANG TRẠI";
    }
  },
};
</script>
