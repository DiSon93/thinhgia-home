          ...
          <v-col cols="12" sm="8">
            <div class="blog_news">
              <v-row v-if="blogLatest.data.length > 0">
                <v-col cols="12" sm="4">
                  ...
                  >
                    <img
                      :src="blogLatest.data[0].image_public[0].thumbnail"
                      :alt="blogLatest.data[0].title"
                    />
                ...
                <v-col cols="12" sm="8">
                  ...
                  <div
                    class="content"
                    v-html="strip_tags(blogLatest.data[0].content)"
                  ></div>
                </v-col>
              </v-row>
              <v-row v-if="blogLatest.data.length > 1">
                <v-col
                  cols="6"
                  sm="3"
                  v-for="(item, index) in blogLatest.data"
                  :key="index"
                  v-if="index > 0"
                >
            ...
            <div v-if="blogList.length > 0" v-for="item in blogList" :key="item.id">
              <div class="architecture">
                ...
                <v-btn :to="'/blog/category/' + item.slug + '-' + item.id"
                  >Xem Tất cả &gt;&gt;</v-btn
                >
              </div>
