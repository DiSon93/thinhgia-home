                ...
                <div class="header_choise">
                    <el-dropdown placement="top-start" @command="handleCommand">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item v-for="item in dictionaryList.real_estate" :key="item.id" :command="'/category/mua-ban/' + item.name + '-' + item.id">
                    ...
                    <el-dropdown placement="top-start" @command="handleCommand">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item v-for="item in dictionaryList.real_estate" :key="item.id" :command="'/category/cho-thue/' + item.name + '-' + item.id">
                                <span v-html="item.name"></span>
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
