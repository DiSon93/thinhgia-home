    ...
    <v-app>
                ...
                <div class="d-flex header_left">
                    ...
                    <div class="header_choise">
                        ...
                        <el-dropdown placement="top-start" @command="handleCommand">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item v-for="item in dictionaryList.project" :key="item.id" :command="'/project/' + item.slug + '-' + item.id">
                                <span v-html="item.name"></span>
                                </el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                ...
                <div class="header_right">
                    <div class="header_choise">
                        ...
                        <el-dropdown placement="top-start" @command="handleCommand">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item v-for="item in blogList" :key="item.id" :command="'/blog/category/' + item.slug + '-' + item.id">
                                    <span v-html="item.name"></span>
                                </el-dropdown-item>
        ...
        <div>
            ...
            <div class="floating_button">
                <div class="zalo-chat-widget" data-oaid="53253160592962497" data-welcome-message="Rất vui khi được hỗ trợ bạn!" data-autopopup="0" data-width="" data-height=""></div>
