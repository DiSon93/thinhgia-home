                ...
                <v-col cols="6" sm="3" class="options" align="center">
                    <div class="select_type">
                        <el-cascader
                            ...
                            v-model="frmSearch.typeRealEstate"
                        >
                        </el-cascader>
                    </div>
                </v-col>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState('search', ['provinces', 'districts', 'wards', 'areas', 'prices', 'typeRealEstate', 'directions'])
        },
        mounted() {
            ...
            if (params != undefined) {
                ...
                if (_purpose[2] == this.purpose_array[0].key || _purpose[2] == this.purpose_array[0].slug) {
        ...
        methods: {
            ...
            ...mapActions('search', ['getProvince', 'getDistrict', 'getWard', 'getAreas', 'getPrices', 'getTypeRealEstate', 'getDirections']),
            ...
            btnSearch() {
                ...
                if (this.frmSearch.typeRealEstate.length > 0) {
                    query.push('real_estate_type=' + this.frmSearch.typeRealEstate[0]);
                }
